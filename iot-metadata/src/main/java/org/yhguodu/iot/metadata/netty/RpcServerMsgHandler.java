 ...
 */
public class RpcServerMsgHandler extends SimpleChannelInboundHandler<RpcMessageRequest> {
...
//    }
  ...
  /*  @Override
    ...
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, RpcMessageRequest rpcMessageRequest) throws Exception {
        handler.readEvent(new RpcEvent(rpcMessageRequest,channelHandlerContext.channel()));
    }
